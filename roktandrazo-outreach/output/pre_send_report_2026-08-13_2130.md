# BD Pre-Send Report — 2026-08-13 (ET 09:30 / CST 21:30)

**Batch ID:** `new_outreach_20260813_et1000`
**Generated:** 2026-08-13 21:27:37 Asia/Shanghai
...
| Check | Result |
|-------|--------|
| Frozen snapshot | `frozen_new_outreach_20260813_et1000.json` — NOT FOUND |
| Last known snapshot | `frozen_new_outreach_20260804_et1000.json` (Aug 4) |
| Consecutive weekdays without freeze | 7 (Aug 5–13) |

## DB Context (FYI only — no action taken)

| Metric | Value |
|--------|-------|
| Raw eligible unsent (ALLOWED_STATES) | 36 |
| Today sent | 0 |
...
- [x] Confirmed no `frozen_new_outreach_20260813_et1000.json` exists (checked output/ and data/)
