# BD Pre-Send Report — 2026-08-14 (ET 09:30 / CST 21:30)

**Batch ID:** `new_outreach_20260814_et1000`
**Generated:** 2026-08-14 21:26:32 Asia/Shanghai
...
| Check | Result |
|-------|--------|
| Frozen snapshot | `frozen_new_outreach_20260814_et1000.json` — NOT FOUND |
...
| Metric | Value |
|--------|-------|
| Raw eligible unsent (ALLOWED_STATES) | 30 |
| Today sent | 0 |
...
- [x] Confirmed no `frozen_new_outreach_20260814_et1000.json` exists (checked output/ and data/)
