# BD Pre-Send Report — 2026-08-17 (ET 09:30 / CST 21:30)

**Batch ID:** `new_outreach_20260817_et1000`
**Generated:** 2026-08-17 21:26:21 Asia/Shanghai
...
| Check | Result |
|-------|--------|
| Frozen snapshot | `frozen_new_outreach_20260817_et1000.json` — NOT FOUND |
...
| Metric | Value |
|--------|-------|
| Raw eligible unsent (ALLOWED_STATES) | 35 |
| Today sent | 0 |
...
- [x] Confirmed no `frozen_new_outreach_20260817_et1000.json` exists (checked output/ and data/)
