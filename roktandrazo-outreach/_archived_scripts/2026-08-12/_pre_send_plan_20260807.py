#!/usr/bin/env python3
"""
BD Production Pre-Send — 21:30 Asia/Shanghai — 2026-08-07
Read frozen snapshot → Query DB → Create Final Send Plan (30 orgs, no SMTP)

batch_id: new_outreach_20260807_et1000
NO SMTP. Follow-up = 0.
"""
...
# If snapshot exists, proceed with full plan...
print(f'  Snapshot loaded: count={snapshot["count"]}...')
# ... rest of the plan generation (same as archived script)
...
print(f'  Match: {"OK" if verify == auth_verify == len(selected) else "FAIL"}')
