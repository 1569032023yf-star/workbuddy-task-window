"""BD Production Pre-Send — 2026-08-13. NO SMTP. Read frozen snapshot, else NO_BATCH_TODAY."""
import sqlite3
import os
...
# Both possible snapshot locations (output/ primary, data/ fallback)
candidate_paths = [
...
| Consecutive days without freeze | 7 (Aug 5–13) |
...
"""
    ...
    # Success path not reached — no snapshot today.
