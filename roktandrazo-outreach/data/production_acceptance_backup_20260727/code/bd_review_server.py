...
<div class="modal" id="emailModal"><div class="modal-box">
  ...
  <div class="modal-actions"><button class="btn btn-ap" onclick="submitOfficialEmail()">Verify and Promote / 验证并尝试升级</button><button class="btn" onclick="closeEmailModal()">Cancel / 取消</button></div>
</div></div>
