...
class LaneState:
    def __init__(self):
        ...
        self.lane_stats = {lane: {"processed": 0, "a0_added": 0, "failed": 0} for lane in LANE_ORDER}
...
def main():
    ...
    write_status(
        ...
        a0_added=0,
        unique_auto_sendable=a0_initial,
        ssl_timeout_count=0,
        last_error=None,
    )
        ...
        while a0_current < TARGET:
            ...
            if elapsed >= MAX_RUNTIME_MINUTES:
                write_status(
                    ...
                    a0_current=a0_current,
                    gap=TARGET - a0_current,
                    loops=loop_count,
                )
                break
            ...
            print(f"  A0: {a0_current}/{TARGET} | Batch: {batch_size} | Elapsed: {elapsed:.0f}min")
            print(f"{'='*60}")
            ...
            lane_state.lane_stats[lane_state.current_lane]['a0_added'] += batch_added
            ...
            write_status(
                ...
                a0_added=total_a0_added,
                unique_auto_sendable=a0_current,
            ...
            print(f"\n  Batch result: +{batch_added} A0 | Pool: {a0_current}/{TARGET}")

            if a0_current >= TARGET:
                write_status(
                    status="complete",
                    a0_current=a0_current,
                    gap=0,
